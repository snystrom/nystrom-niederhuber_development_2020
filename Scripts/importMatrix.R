# this is from the master branch of motifStack package:
# https://github.com/jianhong/motifStack
# Just don't want to upgrade R and bioconductor for this one function...
